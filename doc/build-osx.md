Mac OS X globalboostd build instructions
====================================
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:globalboost-project/globalboost.git globalboost
        cd globalboost
...
Other commands:
    ...
    ./globalboostd --help  # for a list of command-line options.
    ./globalboostd -daemon # to start the globalboost daemon.
    ./globalboostd help    # When the daemon is running, to get a list of RPC commands
