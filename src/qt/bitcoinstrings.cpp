...
QT_TRANSLATE_NOOP("bitcoin-core", "Globalboost version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Globalboost"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 12368 or testnet: 112368)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Globalboost Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or globalboostd"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Globalboost to complete"),
